(() => {
  ...
  brandButtons.forEach(card => {
    card.addEventListener('click', () => {
      ...
      window.open(`https://wa.me/972569238514?text=${encodeURIComponent(text)}`, '_blank', 'noopener');
    });
  });
  ...
  form.addEventListener('submit', event => {
    ...
    window.open(`https://wa.me/972569238514?text=${encodeURIComponent(message)}`, '_blank', 'noopener');
  });
